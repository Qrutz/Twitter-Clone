...
<div className="mx-4 sm:mx-24 md:mx-34 lg:mx-56  flex items-center space-y-10 py-16 font-semibold flex-col">
    ...
    <button className="w-full p-2 bg-sky-400 hover:bg-sky-300 rounded-full text-lg font-semibold  " type="submit"   >Log in</button>
    </form>
        <p>Don't have an account?  
            <Link className=' ml-2 font-semibold text-sky-500 hover:text-sky-800' to="/register">Register</Link></p>
</div>
